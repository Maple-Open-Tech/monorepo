// github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/papercloud/repo/collection/impl.go
package collection
...
func NewRepository(appCfg *config.Configuration, loggerp *zap.Logger, client *mongo.Client) dom_collection.CollectionRepository {
	...
	cc := client.Database(appCfg.DB.PaperCloudName).Collection("collections")
