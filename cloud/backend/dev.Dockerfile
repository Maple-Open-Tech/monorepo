...
COPY . /go/src/github.com/Maple-Open-Tech/monorepo/cloud/backend
# Set the working directory for subsequent commands
# All commands after this will run from this directory
WORKDIR /go/src/github.com/Maple-Open-Tech/monorepo/cloud/backend
...
ENTRYPOINT CompileDaemon -polling=true -log-prefix=false -build="/go/bin/quality-build.sh" -command="./backend daemon" -directory="./"

# ============================================================================
# BUILD INSTRUCTIONS (COMMENTED FOR REFERENCE)
# ============================================================================
# To build this Docker image, run:
# docker build --rm -t backend -f dev.Dockerfile .
