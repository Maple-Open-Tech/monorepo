...
import (
	...
	uc_emailer "github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/ipe/usecase/emailer"
...
func (s *gatewayUserRegisterServiceImpl) Execute(
	...
	if err != nil {
		s.logger.Error("failed creating customer user error", zap.Any("err", err))
		return nil, err
	}
