...
import (
	...
	dom_banip "github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/ipe/domain/bannedipaddress"
)
...
func NewRepository(appCfg *config.Configuration, loggerp *zap.Logger, client *mongo.Client) dom_banip.Repository {
	...
	uc := client.Database(appCfg.DB.IncomePropertyEvaluatorName).Collection("banned_ip_addresses")
