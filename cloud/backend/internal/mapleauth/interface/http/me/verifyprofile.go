// github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/mapleauth/interface/http/me/verifyprofile.go
package me
...
import (
	...
	svc_me "github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/mapleauth/service/me"
...
func (*PostVerifyProfileHTTPHandler) Pattern() string {
	return "POST /mapleauth/api/v1/verify-profile"
}
