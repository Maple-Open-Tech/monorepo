// cloud/backend/internal/papercloud/interface/http/collection/update.go
package collection
...
import (
	...
	svc_collection "github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/papercloud/service/collection"
...
func (*UpdateCollectionHTTPHandler) Pattern() string {
	return "PUT /papercloud/api/v1/collections/{collection_id}"
}
...
func (h *UpdateCollectionHTTPHandler) Execute(w http.ResponseWriter, r *http.Request) {
	...
	transactionFunc := func(sessCtx context.Context) (interface{}, error) {
		...
		if err != nil {
			h.logger.Error("failed to update collection",
				zap.Any("error", err))
			return nil, err
		}
		return response, nil
