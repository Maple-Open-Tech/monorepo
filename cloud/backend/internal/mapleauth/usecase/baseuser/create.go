// github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/mapleauth/usecase/baseuser/create.go
package baseuser
...
func (uc *userCreateUseCaseImpl) Execute(ctx context.Context, user *dom_user.BaseUser) error {
	//
	// STEP 1: Validation.
	//
