// github.com/Maple-Open-Tech/monorepo/cloud/backend/internal/ipe/repo/user/impl.go
package user
...
func NewRepository(appCfg *config.Configuration, loggerp *zap.Logger, client *mongo.Client) dom_user.Repository {
	...
	uc := client.Database(appCfg.DB.IncomePropertyEvaluatorName).Collection("users")
